        ...
        'results': [
            {
                ...
                'values': {
                    # Mac address details
                    'Valid MAC address': "True"
                    if response.mac_address_details.is_valid
                    else "False",
                    ...
                    'Vendor details are hidden': "True"
                    if response.vendor_details.is_private
                    else "False",
                    ...
                    # Block details
                    'Block found': "True"
                    if response.block_details.block_found
                    else "False",
